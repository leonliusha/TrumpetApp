...
public class BroadcastFragment extends Fragment {
    ...
    final static String TAG = "BroadcastFragment.class";
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        updateLocalTags();
        btn_sendBroadcast = (Button)view.findViewById(R.id.btn_sendBroadcast);
...
//        toolbar = (Toolbar)this.getActivity().findViewById(R.id.broadcastToolbar);
...
//    }
    ...
    private void dataSettingForTest(){
        TextView tvCoordinate = (TextView)view.findViewById(R.id.tv_brief);
        tvCoordinate.setText(myCoordinate.getMyLatitude() + " " + myCoordinate.getMyLongitude());
    }

    private void initMyCoordinate(){
        //myCoordinate = (MyCoordinate)this.getActivity().getIntent().getSerializableExtra("myCoordinate");
        myCoordinate = mainActivity.myCoordinate;
    }
    ...
    private void sendBroadcastButtonListener(){
        ...
        btn_sendBroadcast.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(mainActivity, R.string.send_toast, Toast.LENGTH_SHORT).show();
...
//                ft.commit();
    ...
    private void showTab(Fragment homeFragment, Fragment currentFragment){
        FragmentTransaction ft = getFragmentManager().beginTransaction();
    ...
    private void initBriefContentListener(){
        etBriefContent = (EditText)view.findViewById(R.id.et_briefContent);
    ...
    private void initDateTimePicker(){
        ...
        layout_changeTime = (LinearLayout) view.findViewById(R.id.ll_change_time);
        tv_expireDate = (TextView) view.findViewById(R.id.tv_expire_date);
        ...
        layout_changeTime.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                DateTimePickerDialog dateTimePicKerDialog = new DateTimePickerDialog(
                        getActivity(), tv_expireDate.getText().toString());
    ...
    private void initTagsSelectListener(){
        ...
        LinearLayout layout_selectTags = (LinearLayout)view.findViewById(R.id.ll_adding_tag);
        final TextView tv_selectedTags = (TextView)view.findViewById(R.id.tv_selected_tags);
        ...
        layout_selectTags.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TagsSelectorDialog tagsDialog = new TagsSelectorDialog(getActivity(),title, Arrays.asList(tags),tagsDialogFontColor,broadcast);
                tagsDialog.initDialog(tv_selectedTags,getActivity().getApplicationContext());
            }
        });
    ...
    private class PostBroadcastTask extends AsyncTask<MediaType, Void, Broadcast> {
        ...
        protected void onPreExecute(){
            ...
            TextView tvSelectedTags = (TextView)view.findViewById(R.id.tv_selected_tags);
            EditText etDescriptionContent = (EditText)view.findViewById(R.id.et_descriptionContent);
...
//        getActivity().getMenuInflater().inflate(R.menu.menu_broadcast, menu);
//        return true;
//    }
